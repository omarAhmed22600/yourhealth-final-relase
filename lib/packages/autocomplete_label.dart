// ignore_for_file: prefer_const_constructors, prefer_final_fields, prefer_is_not_operator, curly_braces_in_flow_control_structures
  ...
  static Widget defaultValueBoxBuilder(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(30.0),
        border: Border.all(
          color: Color(0xFF80B1FE),//all container
          width: 2.0,
      ...
      child: DryIntrinsicWidth(
        child: Padding(
          ...
          child: TextField(
            ...
            // onEditingComplete: onFieldSubmitted,/// We Dont Want The User To Enter his own Way Of Viewing Symptoms
          ),
        ),
      ),
    );
...
class _AutocompleteLabelState<T> extends State<AutocompleteLabel> {
  ...
  OffsetDetectorController _offsetDetectorController;
  ...
  void _handleOptionsBuilder(String text) {
    ...
    i++) {
      ...
      if (widget
          ...
          .toLowerCase()
          .startsWith(text.toLowerCase()) &&//contains(text.toLowerCase())
